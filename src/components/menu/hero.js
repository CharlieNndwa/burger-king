      ...
      <div className="max-width pt-20 mb-28 px-4">
        ...
        <form className="my-8">
          <input
            ...
            className="w-full py-3 px-6 rounded-lg placeholder-[#502215] text-[#502215] bg-white shadow border border-slate-400"
          />
        </form>
        ...
        <ul className="flex items-center justify-evenly">
          {items.map((button, index) => (
            <React.Fragment key={index}>
              <li onClick={() => setValue(index)} className="flex-1 w-full">
                <button
