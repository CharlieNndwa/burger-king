...
export default function Hero() {
  return (
    <>
      <section className="max-width pt-20 mb-20 lg:pt-32 px-4 text-center">
        <Image
          src={royalPerksSvg}
          width={500}
          height={200}
        ...
        <div>
          ...
          <Image
            ...
            className="block mx-auto"
          />
          <h2 className="mb-8">Youre not earning yet?</h2>
          <p className="mb-20">
            Start earning Crowns today by ordering your favourite BK food for
            pickup or delivery!
          </p>
        </div>
        <div>
